"""Reporting and evaluation helpers for BN-LTE."""
...
def render_markdown_report(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "## Scope",
        "",
        "BN-LTE uses train-only explainable pseudotime and biologically constrained baseline parents for future biomarker rates.",
        "",
        "## Data",
        "",
    ...
    if h1.get("tested"):
        ...
        lines.append("- This summarizes stage-varying pT217 effects from the fitted transition model.")
    else:
